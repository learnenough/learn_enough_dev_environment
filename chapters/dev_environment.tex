...
As of this writing, the recommended version of Ruby is Ruby 3.1.1, which you can install and use on the cloud IDE as follows:
...
\noindent (Exact version numbers may differ.) If you're using a tutorial that recommends a different version of Ruby, just replace 3.1.1 with the specified version in the commands above (e.g., 2.7.5).
