...
\noindent (This uses \href{https://rvm.io}{Ruby Version Manager}, which comes preinstalled on the cloud IDE; Section~\ref{sec:rbenv} uses the similar \kode{rbenv} project.) Once that command is finished, you can verify the Ruby version as follows:
