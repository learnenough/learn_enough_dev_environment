...
\noindent This adds \kode{python3} and \kode{pip3} executables (the latter is a Python package manager):
...
\noindent Many online instructions require you to execute \kode{python} or \kode{pip}; in such cases, you should add the trailing~\kode{3} in order to obtain the expected result.
