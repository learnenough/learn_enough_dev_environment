...
At this point, you're done! Although Internet access is required to use Cloud9 (so it can't be used offline), there is no alternative that combines so much power with such an easy setup.
