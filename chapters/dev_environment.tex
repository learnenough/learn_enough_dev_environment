...
We'll use Ruby 2.6.3 in this tutorial, which as of this writing works with a wide variety of Ruby applications, but you can also use \href{https://www.ruby-lang.org/en/downloads/}{current or previous version} as listed at the Ruby website.
...
Finally, we have native instructions for Microsoft Windows. Because none of your humble authors are well-acquainted with Windows software development, we did a Twitter survey, and found that the typical response was ``Use a Linux VM\@.'' That's certainly a possibility (Section~\ref{sec:virtual_machine}), as is using a cloud IDE (Section~\ref{sec:cloud_ide}). Finally, we've had reports of good success with installing Linux directly within Windows, which you can read about in the article ``\href{https://www.hanselman.com/blog/SettingUpAShinyDevelopmentEnvironmentWithinLinuxOnWindows10.aspx}{Setting up a Shiny Development Environment within Linux on Windows~10}'' by \href{https://www.hanselman.com/}{Scott Hanselman}.\footnote{Thanks to reader Mark Craig for suggesting this article.} Let us know how it goes!
